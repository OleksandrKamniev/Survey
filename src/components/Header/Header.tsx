    ...
    return (
        <div className="mb-[20px]">
            <header className="flex items-center my-[10px] relative">
                <div className="absolute left-0 w-[24px] h-[24px] flex items-center justify-center">
                    {history.length>0 && (
                        <button
                            onClick={handleBackPage}
                            className="ml-[15px] w-full h-full flex items-center justify-center"
                        >
                            <Image
                ...
                <div className="mx-auto w-[24px] h-[24px] flex items-center justify-center">
                    <div className="w-[15px] h-[16px] relative">
                        <Image
                            src={
                                isInformScreen ? nebulaLogoWhite : nebulaLogoBlack
                            }
                            alt="Logo"
                            layout="fill"
                            objectFit="cover"
